...
cp 05-extend-rootpart.sh /etc
#echo "/etc/05-extend-rootpart.sh && sed -i '/05-extend-rootpart.sh/d' /etc/rc.local" >> /etc/rc.local
#echo "sed -i '/reboot/d' /etc/rc.local && reboot" >> /etc/rc.local
